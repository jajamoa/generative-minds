...
def extract_housing_data(json_file_path, output_path):
    ...
    for participant_id, data in demographics.items():
        ...
        zipcode = data.get("What is your ZIP code?", "").split(":")[0]  # Remove any trailing colons
        ...
        participant_data = {
            ...
            "agent": {
                ...
                "family type": data.get("Which of the following best describes your household and family situation?", "")
            }
        }
...
def main():
    ...
    # Input file path
    input_path = base_dir / "processed" / "responses_5.4.json"
    
    # Output file path
    output_path = base_dir / "processed" / "agent_5.4.json"
