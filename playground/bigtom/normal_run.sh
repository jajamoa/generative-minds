...
# Optional: peek at the dataset
python dataset.py --input data/bigtom/bigtom.csv --peek 1

# Step 2: Extract motifs from each data sample in train.csv
python extract_motif.py --input data/bigtom/train.csv --output_dir results/normal/motifs_from_bigtom --max_records $DEBUG_TRAIN_SAMPLE
